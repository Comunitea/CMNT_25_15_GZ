...
session.env['stock.location.route']._clean_multi_company_routes()
INSTALAR removal_priority_by_location. CONFIGURAR
INSTALAR split_excess_qty
INSTALAR cross_dock_order_location
