...
class MrpProduction(models.Model):
    ...
    def _get_procurement_domain(self, procurement_group_id):
        return [('procurement_group_id', '=', procurement_group_id)] 
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        return super(MrpProduction, self.with_context(virtual_id=False)).read_group(domain, fields, groupby, offset=offset, limit=limit, orderby=orderby, lazy=lazy)
